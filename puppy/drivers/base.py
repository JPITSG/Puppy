...
class Driver:
    ...
    def build_cmd(self, session: dict, first_turn: bool, prompt: str, pinned_id: str,
        ...
        terminal_mcp is the equivalent descriptor for an explicitly requested
        shared terminal; drivers may receive both in the same turn.

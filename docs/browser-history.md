...
| Phone drawer, Host activity and Notifications | Separate layers, including the drawer's swipe gestures; Back closes them, Forward reopens them. The Notifications header closes its existing layer just like the tray; its clear button only clears history. The two footer boxes share the space under the engine stats, so opening one closes the other |
